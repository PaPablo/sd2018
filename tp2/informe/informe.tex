...
\begin{itemize}
    ...
    \item Ejecutar el cliente con el comando \texttt{java -cp bin CLICliente localhost 21 + 9} - No cerrar el primer mensaje. Cuando se ejecuta una suma, el objeto remoto establece su \dq{estado} al doble del valor resultante de la suma (en este caso, el valor final del estado sería 60)
