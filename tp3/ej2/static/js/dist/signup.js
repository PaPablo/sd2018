...
},{"process":"../node_modules/process/browser.js","buffer":"../node_modules/buffer/index.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var setCustomFeedbackMessages = function setCustomFeedbackMessages(form) {
  /*
   * Modifica los mensajes por defecto de HTML5 
   * cuando lo ingresado en el <input /> es incorrecto
   */
  var INPUTS = getInputFeedbacks();
  ...
  try {
    var _loop = function _loop() {
      ...
      var feedback = INPUTS.find(function (obj) {
        return obj.id === input.id;
      }).feedback; //Lo siguiente lo saqué de este respuesta de SO:
...
var getInputFeedbacks = function getInputFeedbacks() {
  return [{
    id: "nombre",
    feedback: "Debe ingresar su nombre y apellido"
  }, {
    id: "legajo",
    feedback: "Debe ingresar un legajo válido"
  }, {
    id: "edad",
    feedback: "Debe ingresar una edad válida"
  }, {
    id: "password",
...
var getChildValue = function getChildValue(parent, childSelector) {
  try {
...
var onSignupSubmit = function onSignupSubmit(evt) {
  evt.preventDefault();

  try {
    var form = document.querySelector("#signup-form");
    var nombre = getChildValue(form, "#nombre");
    var legajo = getChildValue(form, "#legajo");
    var sexo = getChildValue(form, "#sexo");
    var edad = getChildValue(form, "#edad");
    var password = getChildValue(form, "#password");
    var newForm = makeSecureForm({
      nombre: nombre,
      legajo: legajo,
      sexo: sexo,
      edad: edad,
    ...
    newForm.style.display = "none"; //Hay que agregarlo al `body` para poder mandarlo

    document.body.appendChild(newForm); //Lo mandamos (a mano)

    newForm.submit(); //Devolvemos `false` para que no intente enviar el formulario original
...
var makeSecureForm = function makeSecureForm(fields) {
  /*
  ...
  for (var _f in fields) {
    ...
    var field = _f.trim().toLowerCase();

    var input = document.createElement("input");
    input.name = field;

    if (field === "password") {
      input.value = (0, _jsSha.sha256)(value);
...
},{"js-sha256":"../node_modules/js-sha256/src/sha256.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
